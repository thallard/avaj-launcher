    ...
    public void updateConditions()
    {
        ...
        switch (weatherTower.getWeather(coord)) {
            case "SUN":
                ...
                baloonCord.setLatitude(this.getLatitude() + 10);
            ...
            case "SNOW":
                ...
                baloonCord.setHeight(this.getHeight() - 7);
                break;
            case "RAIN":
